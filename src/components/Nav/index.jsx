    ...
    <Navbar isBordered>
      ...
      <NavbarContent className="sm:hidden pr-3 " justify="center">
        <NavbarBrand>
          ...
          <NavLink to="/" className="font-bold text-inherit text-xl">Find<span className=" text-yellow-400">X</span></NavLink>
    ...
    <button className=" ml-4 border-l-2 px-3 font-semibold" onClick={() => navigate("/employe/register")} >Hire Talent</button>
      ...
      <NavbarMenu>
        ...
        <NavbarItem isActive>
          {role === "Employe" ?
            (
              <NavLink to="/empolye/create" aria-current="page" className="active" >
                Post jobs/Interships
              </NavLink>
            )
            :
            (
              <NavLink to="/student/jobs" className="active" aria-current="page" color="warning">
                Jobs
              </NavLink>
            )
          }
